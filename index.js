...
(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        loadVpois = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, fetch("https://central.gswps.eu:10443/centralapp/spc/get/all")];
                    case 1:
                        res = _a.sent();
                        return [4 /*yield*/, res.json()];
                    case 2:
                        vpois = _a.sent();
                        return [2 /*return*/, vpois];
                    case 3:
                        error_1 = _a.sent();
        ...
        init = function () { return __awaiter(_this, void 0, void 0, function () {
            var vpois, vpoisdynamic, errorDiv;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loadVpois()];
                    case 1:
                        vpois = _a.sent();
                        if (vpois) {
                            renderVpois(vpois);
                            vpoisdynamic = document.getElementById("vpois-dynamic");
